# script for generating supplemental tables before figure creation from Nygard et al. 2025 Bioinformatics submission
from gothic import *

# generate/reformat organized tables from TPD, MCL, Spectral experiments for figure generation and publication
# run this before getBioinfoPaperFigs.py to get figures from Nygard et al. 2025

if __name__ == '__main__':
    cases = '1a', '1b', '1c'
    for case in cases:
        print(case)  # TODO remove?
        # instantiate all files
        # use suffix names listed here to select appropriate files from fullRunTPD.py and fullRunSpectralMCL.py
