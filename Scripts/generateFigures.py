# Script for generating figures from Nygard et al. 2025 after fullRunTPD.py, fullRunSpectralMCL.py, and TableReformat.py
from gothic import *
from matplotlib.colors import LinearSegmentedColormap

# instantiate cases to loop through and figures created outside main loop (modify for your use case)
...
#constants
fdrthresh = 0.25  # False Discovery Rate Threshold to be considered significant
pvalthresh = 0.05  # p-value threshold to pe considered significant
plotxranges = [0.1, 1]
...
for case in cases:
    ...
    # use suffix names listed here to select appropriate files from fullRunTPD.py,fullRunSpectralMCL.py,and TableReformat.py
    # modify as necessary for your own analysis
